...
const Banner = ({query, handleInputChange}) => {
    return (
        <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-10">
            <h1 className="text-5xl font-bold text-primary mb-3">Find your <span
                className="text-blue">new job</span> today</h1>
            ...
            <form>
                <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4">
                    <div
                        ...
                        <input type="text" name="title" placeholder="What position are you looking for ?"
